...
const menuItems = document.querySelectorAll('header > menu > ul > li'); /* .can-hover > li */
...
console.log("blur");
    ...
    item.addEventListener('mousedown', (event) => {
        ...
        const clickedLi = event.target.closest('header > menu > ul > li li'); /* .can-hover > li li */
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (isMacOS) {
      ...
      document.body.classList.add('windows'); // You can add more conditions for other OS if needed
    }
});
