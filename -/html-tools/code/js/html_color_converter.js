...
document.getElementById('color').addEventListener('keyup', function() {
  ...
  if (color.valid) {
    ...
    document.getElementById('ncol').innerHTML = ncol;
    ...
    if (color.opacity === 1) {
      ...
      document.getElementById('rgbName').textContent = 'Rgb';
      document.getElementById('hslName').textContent = 'Hsl';
      document.getElementById('hwbName').textContent = 'Hwb';
    } else {
      rgb = color.toRgbaString();
      hsl = color.toHslaString();
      hwb = color.toHwbaString();

      document.getElementById('rgbName').textContent = 'Rgba';
      document.getElementById('hslName').textContent = 'Hsla';
      document.getElementById('hwbName').textContent = 'Hwba';
    }

    document.getElementById('rgb').innerHTML = rgb;
    document.getElementById('hsl').innerHTML = hsl;
    document.getElementById('hwb').innerHTML = hwb;
    ...
    document.getElementById('currentColor').classList.remove('hidden');

    document.querySelectorAll('.colors, #currentColor').forEach(el => {
    ...
    document.getElementById('currentColor').classList.add('hidden');
